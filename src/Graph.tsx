...
class Graph extends Component<IProps, {}> {
  ...
  componentDidMount() {
    ...
    const elem: PerspectiveViewerElement = document.getElementsByTagName('perspective-viewer')[0] as PerspectiveViewerElement; // Simplify assignment
    ...
    if (this.table) {
      ...
      // Add more attributes to the element for configuration
